...
class PurchaseOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        'products' => 'required|array|min:1',
         'products.*.purchase_price' => 'required|numeric|min:1', // min:1 để không cho đơn giá = 0
    ...
    public function messages(): array
    {
        return [
            ...
            'expected_delivery_date.required' => 'Ngày giao hàng dự kiến là bắt buộc.',
            'expected_delivery_date.date' => 'Ngày giao hàng dự kiến phải là định dạng ngày hợp lệ.',
            'expected_delivery_date.after_or_equal' => 'Ngày giao hàng dự kiến phải sau hoặc bằng ngày đặt hàng.',
            ...
            'items.*.unit_cost.min' => 'Đơn giá phải lớn hơn 0.',
