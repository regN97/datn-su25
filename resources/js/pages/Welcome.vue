            ...
            <nav class="flex items-center justify-end gap-4">
                <template v-if="$page.props.auth?.user">
                    <Link
                        ...
                        class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] transition-all duration-200 ease-in-out hover:scale-105 hover:border-[#1915014a] hover:shadow-sm dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                    >
                        Dashboard
                    </Link>
                </template>
                ...
                <template v-else>
                    <div class="relative">
                        <button
                            ...
                            class="inline-flex items-center rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] transition-all duration-200 ease-in-out hover:scale-105 hover:border-[#1915014a] hover:shadow-sm focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-white focus:outline-none dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                        >
                            Đăng nhập
                            <svg
                                class="-mr-0.5 ml-2 h-4 w-4 transform transition-transform duration-200 ease-in-out"
                                :class="{ 'rotate-180': showLoginOptions }"
                        ...
                        >
                            <div
                                ...
                                @click.away="closeLoginOptions"
                                class="ring-opacity-5 absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black focus:outline-none dark:bg-[#2D2D2A]"
                            >
                                <div class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                    <Link
                                        :href="route('login')"
                                        class="block px-4 py-2 text-sm text-[#1b1b18] transition-colors duration-150 ease-in-out hover:bg-gray-100 dark:text-[#EDEDEC] dark:hover:bg-[#3E3E3A]"
                                        role="menuitem"
                                    >
                                        Đăng nhập Admin
                                    </Link>
