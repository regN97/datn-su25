              ...
              <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                  <div id="activity-list" class="max-h-96 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                    <div v-for="activity in recentActivities" :key="activity.time" class="pb-4 border-b border-gray-100 last:border-b-0">
              ...
              <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                  <p class="text-gray-600 text-sm flex justify-between items-center">
                    ...
                    <span class="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded">{{ quickStats.totalTransactions }}</span>
                  </p>
                  <p class="text-gray-600 text-sm flex justify-between items-center">
                    <strong class="font-semibold">Tổng doanh thu:</strong>
                    <span class="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded">{{ quickStats.totalRevenue }} VNĐ</span>
                  </p>
                  <p class="text-gray-600 text-sm flex justify-between items-center">
                    <strong class="font-semibold">Trả hàng/đổi hàng:</strong>
                    <span class="bg-gray-100 text-gray-700 text-xs font-medium px-2 py-0.5 rounded">{{ quickStats.totalReturns }}</span>
                  </p>
              ...
              <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                  <div :class="{'max-h-[28rem] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100': importantNotifications.length >= 10}">
                    <ul class="space-y-4">
                      <li v-for="notification in importantNotifications" :key="notification.time" class="pb-4 border-b border-gray-100 last:border-b-0">
                        <div class="flex items-center">
                          <span v-if="notification.isNew" class="bg-red-100 text-red-600 text-xs font-medium px-1.5 py-0.5 rounded mr-2">Mới</span>
