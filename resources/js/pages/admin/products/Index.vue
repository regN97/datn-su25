...
import { Eye, EyeOff, Filter, PackagePlus, Pencil, Trash2 } from 'lucide-vue-next';
...
const filteredProducts = computed(() => {
    return products.filter((product) => {
        ...
        const matchesMinPrice = filterMinPrice.value === null || product.selling_price >= filterMinPrice.value;
        const matchesMaxPrice = filterMaxPrice.value === null || product.selling_price <= filterMaxPrice.value;
        ...
        return matchesName && matchesCategory && matchesStatus && matchesMinPrice && matchesMaxPrice && matchesUnit && matchesSuppliers;
    });
});
                                                ...
                                                <div class="grid grid-cols-1 gap-6 text-sm text-gray-700 md:grid-cols-2">
                                                    <div class="space-y-4">
                                                        <div class="flex items-start">
                                                            <span class="w-32 font-semibold text-gray-900">Mã vạch:</span>
                                                            <span>{{ product.barcode || 'Không có' }}</span>
                                                        </div>
                                                        <div class="flex items-start">
                                                            <span class="w-32 font-semibold text-gray-900">Danh mục:</span>
                                                            <span>{{ getCategoryName(product.category_id) || 'Không có' }}</span>
                                                        </div>
                                                        <div class="flex items-start">
                                                            <span class="w-32 font-semibold text-gray-900">Đơn vị:</span>
                                                            <span>{{ getUnitName(product.unit_id) || 'Không có' }}</span>
                                                        </div>
                                                        <div class="flex items-start">
                                                    ...
                                                    <div class="space-y-4">
                                                        <div class="flex items-start">
                                                            <span class="w-32 font-semibold text-gray-900">Giá bán:</span>
                                                            <span>{{
                                                        ...
                                                        <div class="flex items-start">
                                                            <span class="w-32 font-semibold text-gray-900">Tồn kho tối thiểu:</span>
                                                        ...
                                                        <div class="flex items-start">
                                                            <span class="w-32 font-semibold text-gray-900">Nhà cung cấp:</span>
                                                            <div>
