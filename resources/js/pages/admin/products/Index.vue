...
import { Eye, EyeOff, Filter, PackagePlus, Pencil, Trash, Trash2 } from 'lucide-vue-next';
                                        ...
                                        >
                                            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                                                ...
                                                <div class="mt-6 border-t pt-6 text-sm text-gray-700">
                                                            ...
                                                            <table class="w-full min-w-[300px] text-sm">
                                                                <thead>
                                                                    <tr class="bg-gray-100 text-left">
                                                                        <th class="px-4 py-2 font-semibold text-gray-700">Tên nhà cung cấp</th>
                                                                        <th class="px-4 py-2 text-right font-semibold text-gray-700">Giá nhập</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <td class="px-4 py-2 text-right">
                                                                            ...
                                                                            <template v-else>
                                                                                <span class="text-gray-500">(Chưa có giá)</span>
                                                                            </template>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                    ...
                                                    <template v-else>
                                                        <p class="text-gray-600">Sản phẩm này hiện chưa có nhà cung cấp nào.</p>
                                                    </template>
                                                </div>
                                            </div>
                                        </td>
