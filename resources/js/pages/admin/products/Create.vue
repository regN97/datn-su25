                        ...
                        <div class="grid grid-cols-4 gap-6">
                            <div class="col-span-3 space-y-6">
                                <div class="grid grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        <label for="barcode" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300"> Mã vạch </label>
                                        <input
                                            type="text"
                                            id="barcode"
                                    ...
                                    <div>
                                        <label for="is_active" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div>
                                        <label for="min_stock_level" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div>
                                        <label for="max_stock_level" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Tồn kho tối đa
                                        </label>
                                        <input
                                            type="number"
                                    ...
                                    <div>
                                        <label for="selling_price" class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="col-span-3">
                                        <div v-if="form.selected_supplier_ids.length > 0" class="space-y-3">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div
                                                    v-for="supplierId in form.selected_supplier_ids"
                                                    :key="supplierId"
                                                ...
                                                >
                                                    <label
                                                        :for="`supplier_price_${supplierId}`"
                                                    ...
                                                    <div class="flex-1">
                                                        <input
                                                            type="number"
                                                            :id="`supplier_price_${supplierId}`"
                                                            v-model.number="form.purchase_prices[supplierId]"
                                                            min="0"
                                                            class="h-10 w-full rounded-md border border-gray-300 px-3 text-gray-800 placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:outline-none dark:bg-gray-700 dark:text-gray-200"
                                                            placeholder="Nhập giá nhập"
                                                        />
                                                        <InputError :message="getPurchasePriceErrorMessage(supplierId)" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        maxlength="5000"
                                    ></textarea>
                                    <span class="mt-1 block text-right text-xs text-gray-500">{{ descriptionCharCount }}/5000</span>
                            ...
                            <div class="col-span-1 space-y-6">
                                ...
                                >
                                    ...
                                    <div v-if="imageInputType === 'url'">
                                        ...
                                        />
                                        <span class="mt-1 block text-xs text-gray-500">+ Nên thêm miền URL hoặc tải ảnh trực tiếp</span>
                                        <span class="mt-1 block text-xs text-gray-500">(Dung lượng ảnh tối đa 2MB)</span>
                                    ...
                                    <div v-else>
                                        ...
                                        <span v-if="form.image_file" class="mt-1 block text-xs text-gray-500">
                                            ...
                                            <button type="button" @click="clearImageFile" class="ml-2 text-xs text-red-500 hover:text-red-700">
                                                Xóa
                                            </button>
                                        </span>
                                        <span class="mt-1 block text-xs text-gray-500">Tối đa 2MB (JPEG, PNG, GIF, WEBP)</span>
