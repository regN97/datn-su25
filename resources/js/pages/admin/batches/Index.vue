                ...
                <div class="container mx-auto p-6">
                    <div class="mb-6 flex flex-col items-center justify-between gap-4 md:flex-row">
                        ...
                        <div class="ml-auto flex gap-4">
                            ...
                            <button class="rounded-3xl bg-gray-500 px-4 py-2 text-white hover:bg-gray-600">Thùng rác</button>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 overflow-x-auto rounded-lg border border-gray-200 shadow-md">
                        <table class="w-full bg-white text-left">
                            <thead class="border-b border-gray-200 bg-gray-100">
                                <tr>
                                    <th class="w-[10%] p-4 text-left text-xs font-semibold tracking-wider text-gray-600 uppercase select-none">
                                        Mã lô hàng
                                    </th>
                                    <th class="w-[15%] p-4 text-left text-xs font-semibold tracking-wider text-gray-600 uppercase select-none">
                                        Nhà cung cấp
                                    </th>
                    ...
                    <Pagination
                        :total-items="filteredAndSortedBatches.length"
